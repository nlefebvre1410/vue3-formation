...
export default {
  ...
  emits: ['edit', 'delete', 'toggle-favorite', 'view-details'],
  setup(props) {
    ...
    const handleImageError = (event) => {
      event.target.src = `https://via.placeholder.com/300x450/667eea/ffffff?text=${encodeURIComponent(props.movie.title)}`
    }
