    ...
    <div v-if="movie" class="movie-detail">
      ...
      <div class="movie-nav">
        ...
        <div class="movie-actions">
          ...
          <button @click="handleDeleteMovie" class="btn btn-danger">
            🗑️ Supprimer
          </button>
        </div>
      </div>
...
const handleImageError = (event) => {
  ...
  event.target.src = createPlaceholderSvg(movie.value.title)
}
...
// Renommer pour éviter le conflit avec la fonction importée
const deleteMovieHandler = handleDeleteMovie
</script>
